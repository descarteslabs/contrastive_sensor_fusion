...
if __name__ == '__main__':
    ...
    train_dataset = get_dataset('gs://dl-appsci/cv-sandbox/data/semantic_segmentation/buildings_x4/tfrecords/train-*')
    eval_dataset = get_dataset('gs://dl-appsci/cv-sandbox/data/semantic_segmentation/buildings_x4/tfrecords/eval-*')
    test_dataset = get_dataset('gs://dl-appsci/cv-sandbox/data/semantic_segmentation/buildings_x4/tfrecords/test-*')
