...
def sensor_fusion_experiment():
    ...
    checkpoint_dir = '***REMOVED***outputs/basenets_fusion_tpu_deploy_2' # later?
    ...
    train_dataset = get_dataset('***REMOVED******REMOVED***data/semantic_segmentation/buildings/tfrecords/train-*')
    val_dataset = get_dataset('***REMOVED******REMOVED***data/semantic_segmentation/buildings/tfrecords/eval-*')
    test_dataset = get_dataset('***REMOVED******REMOVED***data/semantic_segmentation/buildings/tfrecords/test-*')
